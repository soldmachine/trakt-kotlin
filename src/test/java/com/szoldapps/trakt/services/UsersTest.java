...
import com.szoldapps.trakt.entities.Followed;
import com.szoldapps.trakt.entities.Follower;
import com.szoldapps.trakt.entities.Friend;
import com.szoldapps.trakt.entities.HistoryEntry;
import com.szoldapps.trakt.entities.ListEntry;
import com.szoldapps.trakt.entities.ListItemRank;
import com.szoldapps.trakt.entities.ListReorderResponse;
...
import com.szoldapps.trakt.entities.SyncPerson;
import com.szoldapps.trakt.entities.SyncResponse;
import com.szoldapps.trakt.entities.SyncShow;
import com.szoldapps.trakt.entities.TraktList;
import com.szoldapps.trakt.entities.UserSlug;
...
import com.szoldapps.trakt.enums.HistoryType;
import com.szoldapps.trakt.enums.ListPrivacy;
...
import com.szoldapps.trakt.entities.ListReorderResponse;
import com.szoldapps.trakt.entities.MovieIds;
import com.szoldapps.trakt.entities.PersonIds;
import com.szoldapps.trakt.entities.RatedEpisode;
import com.szoldapps.trakt.entities.RatedMovie;
import com.szoldapps.trakt.entities.RatedSeason;
import com.szoldapps.trakt.entities.RatedShow;
import com.szoldapps.trakt.entities.Settings;
import com.szoldapps.trakt.entities.ShowIds;
import com.szoldapps.trakt.entities.SyncItems;
import com.szoldapps.trakt.entities.SyncMovie;
import com.szoldapps.trakt.entities.SyncPerson;
...
import com.szoldapps.trakt.entities.SyncShow;
import com.szoldapps.trakt.entities.TraktList;
import com.szoldapps.trakt.entities.User;
import com.szoldapps.trakt.entities.UserSlug;
import com.szoldapps.trakt.entities.WatchlistedEpisode;
import com.szoldapps.trakt.entities.WatchlistedSeason;
import com.szoldapps.trakt.enums.Extended;
...
public class UsersTest extends BaseTestCase {
    ...
    public void test_lists() throws IOException {
        ...
        for (TraktList list : lists) {
            ...
            Assertions.assertThat(list.getPrivacy()).isNotNull();
            assertThat(list.getDisplay_numbers()).isNotNull();
            assertThat(list.getAllow_comments()).isNotNull();
            Assertions.assertThat(list.getSort_by()).isNotNull();
            Assertions.assertThat(list.getSort_how()).isNotNull();

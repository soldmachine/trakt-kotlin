...
import com.szoldapps.trakt.entities.TraktError
import com.szoldapps.trakt.services.Authentication
import com.szoldapps.trakt.services.Calendars
import com.szoldapps.trakt.services.Checkin
import com.szoldapps.trakt.services.Comments
import com.szoldapps.trakt.services.Episodes
import com.szoldapps.trakt.services.Genres
import com.szoldapps.trakt.services.Movies
import com.szoldapps.trakt.services.People
import com.szoldapps.trakt.services.Recommendations
import com.szoldapps.trakt.services.Search
import com.szoldapps.trakt.services.Seasons
import com.szoldapps.trakt.services.Shows
import com.szoldapps.trakt.services.Sync
import com.szoldapps.trakt.services.Users
...
open class TraktV2 {
    ...
    fun apiKey(apiKey: String): com.szoldapps.trakt.TraktV2 {
        this.apiKey = apiKey
        return this
    }
     ...
     */
    fun accessToken(accessToken: String?): com.szoldapps.trakt.TraktV2 {
     ...
     * token.
     */
    fun refreshToken(refreshToken: String?): com.szoldapps.trakt.TraktV2 {
    ...
    private fun retrofitBuilder(): Retrofit.Builder {
        return Retrofit.Builder()
            .baseUrl(com.szoldapps.trakt.TraktV2.Companion.API_URL)
            .addConverterFactory(GsonConverterFactory.create(com.szoldapps.trakt.TraktV2Helper.gsonBuilder.create()))
            .client(okHttpClient())
    }
    ...
    protected open fun setOkHttpClientDefaults(builder: OkHttpClient.Builder) {
        builder.addNetworkInterceptor(com.szoldapps.trakt.TraktV2Interceptor(this))
        builder.authenticator(com.szoldapps.trakt.TraktV2Authenticator(this))
    }
    ...
    fun buildAuthorizationUrl(state: String): String {
        val authUrl = StringBuilder(com.szoldapps.trakt.TraktV2.Companion.OAUTH2_AUTHORIZATION_URL)
    ...
    companion object {
        ...
        const val API_URL = "https://${com.szoldapps.trakt.TraktV2.Companion.API_HOST}/"
        const val API_VERSION = "2"

        const val SITE_URL = "https://trakt.tv"
        const val OAUTH2_AUTHORIZATION_URL = "${com.szoldapps.trakt.TraktV2.Companion.SITE_URL}/oauth/authorize"
        const val OAUTH2_TOKEN_URL = "${com.szoldapps.trakt.TraktV2.Companion.SITE_URL}/oauth/token"

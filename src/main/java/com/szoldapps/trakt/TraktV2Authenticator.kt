...
class TraktV2Authenticator(val trakt: com.szoldapps.trakt.TraktV2) : Authenticator {
    ...
    companion object {
         ...
         */
        @Throws(IOException::class)
        fun handleAuthenticate(response: Response, trakt: com.szoldapps.trakt.TraktV2): Request? {
            if (com.szoldapps.trakt.TraktV2.API_HOST != response.request().url().host()) {
